...
Submit the following files to the LMS. You will produce these as you work
through the three scenarios below. Do not include the JSON files generated by
k6.
...
- `k6-output-r5.txt` through `k6-output-r30.txt` — scaling experiment k6 output
