...
navTitle: Overview
navOrder: 1
permalink: '/{{ semester }}/prj/'
---

# COMPSCI 426 Team Project

Over the final five weeks of the semester, your team will design and build a scalable distributed system using Docker Compose. The project is organized into four one-week sprints, each with a TA demo and graded submission.
...
- **Starter repository:** [github.com/umass-cs-426/starter-project](https://github.com/umass-cs-426/starter-project)
- **Sprint 1 kickoff:** 04.07 — fork the starter, add teammates, create `dev`, commit your Sprint 1 plan before leaving class
- **Sprint 1 due:** 04.14 before class — push code and tag `sprint-1`
